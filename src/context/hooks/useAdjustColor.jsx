...
/**
 * This hook is used to adjust the color of a given color by a given percentage
 * @param {*} percentage
 * @param {*} color1
 * @param {*} color2
 * @param {*} linearBlend
...
const useAdjustColor = (percentage, color1, color2, linearBlend) => {
  return useMemo(
    () => shadeBlendConvert(percentage, color1, color2, linearBlend),
    [percentage, color1, color2, linearBlend]
  );
};
