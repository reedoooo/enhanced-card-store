...
//       const updatedCards = cardsResponse?.collection?.cards || [];
//       const chartPayload = {
//         cards: updatedCards,
//       };
...
//       const chartMessage = chartResponse?.chartMessage || '';
//       const updatedChartData = chartResponse?.allXYValues || [];
//       const newUpdatedCards = chartResponse?.updatedCards || [];
//       console.log(
...
// //         con>st updatedQuantity = card.quantity;
// //         const updatedTotalPriceForCard = card.price * updatedQuantity;
// //         const newCardValueWithUpdatedPrice = {
// //           ...card,
// //           quantity: updatedQuantity,
